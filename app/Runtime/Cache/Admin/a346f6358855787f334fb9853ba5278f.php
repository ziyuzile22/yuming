                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <xblock>
                            ...
                            <button class="layui-btn" onclick="window.open('/admin.php/Role/zadd', 'right')"><i class="layui-icon"></i>添加角色</button>
                        ...
                        <table class="layui-table">
                            ...
                            <tbody id="tbody">
                                <?php if(is_array($roleinfo)): $i = 0; $__LIST__ = $roleinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                        <td>
                                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo ($data["role_id"]); ?>'><i class="layui-icon">&#xe605;</i></div>
                                        </td>
                                        <td><?php echo ($data["role_id"]); ?></td>
                                        <td><?php echo ($data["role_name"]); ?></td>
                                        
                                        <td><?php echo (date("Y-m-d", $data["role_addtime"])); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["role_lasttime"])); ?></td>
                                        <td>
                                            <a class="layui-btn layui-btn-xs" href="/admin.php/Role/distribute/role_id/<?php echo ($data["role_id"]); ?>" >分配权限</a>
                                            <a class="layui-btn layui-btn-xs" href="/admin.php/Role/zedit/role_id/<?php echo ($data["role_id"]); ?>">编辑</a>
                                            <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="member_del(this,'<?php echo ($data["role_id"]); ?>')" href="javascript:;">删除</a>
                                        </td>
