                            ...
                            <form class="layui-form" action="">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_name" required lay-verify="required" placeholder="请输入服务器名称" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">项目主管</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_admin" required lay-verify="required" placeholder="请输入项目主管" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_bei" placeholder="请输入备案地址" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">备案账号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_beiname" placeholder="请输入备案账号" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">备案密码</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_beipwd" placeholder="请输入备案密码" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">绑定手机号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_tell" placeholder="请输入绑定手机号" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">手机联系人</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_tellname" placeholder="请输入手机联系人" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="xm_bz" placeholder="备注" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
