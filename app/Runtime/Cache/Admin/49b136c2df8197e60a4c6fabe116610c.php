                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <xblock>
                            ...
                            <button class="layui-btn" onclick="window.open('/admin.php/Zh/zadd', 'right')"><i class="layui-icon"></i>添加</button>
                        ...
                        <table class="layui-table">
                            ...
                            <tbody id="tbody">
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                        <td>
                                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo ($data["zh_id"]); ?>'><i class="layui-icon">&#xe605;</i></div>
                                        </td>
                                        <td><?php echo ($data["zh_id"]); ?></td>
                                        <td><?php echo ($data["zh_name"]); ?></td>
                                        <td><?php echo ($data["zh_bz"]); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["zh_addtime"])); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["zh_lasttime"])); ?></td>
                                        <td>
                                            <a class="layui-btn layui-btn-xs" href="/admin.php/Zh/zedit/zh_id/<?php echo ($data["zh_id"]); ?>">编辑</a>
                                            <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="member_del(this,'<?php echo ($data["zh_id"]); ?>')" href="javascript:;">删除</a>
                                        </td>
