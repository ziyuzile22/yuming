                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <xblock>
                            ...
                            <button class="layui-btn" onclick="window.open('/admin.php/Xm/zadd', 'right')"><i class="layui-icon"></i>添加</button>
                        ...
                        <table class="layui-table">
                            ...
                            <tbody id="tbody">
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                        <td>
                                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo ($data["xm_id"]); ?>'><i class="layui-icon">&#xe605;</i></div>
                                        </td>
                                        <td><?php echo ($i); ?></td>
                                        <td><?php echo ($data["xm_name"]); ?></td>
                                        <td><?php echo ($data["xm_admin"]); ?></td>
                                        <td><?php echo ($data["xm_bei"]); ?></td>
                                        <td><?php echo ($data["xm_beiname"]); ?></td>
                                        <td><?php echo ($data["xm_beipwd"]); ?></td>
                                        <td><?php echo ($data["xm_tell"]); ?></td>
                                        <td><?php echo ($data["xm_tellname"]); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["xm_addtime"])); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["xm_lasttime"])); ?></td>
                                        <td>
                                            <a class="layui-btn layui-btn-xs" href="/admin.php/Xm/zedit/xm_id/<?php echo ($data["xm_id"]); ?>">编辑</a>
                                            <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="member_del(this,'<?php echo ($data["xm_id"]); ?>')" href="javascript:;">删除</a>
                                        </td>
