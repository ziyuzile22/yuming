                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <select name="auth_pid">
                                            ...
                                            <?php if(is_array($pidinfo)): $i = 0; $__LIST__ = $pidinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            $.post(url, data, function(result) {
                ...
                if (result.status == 1) {
                    layer.msg(result.message, { icon: 1, time: 800 }, function() {
                        window.location.href = "/admin.php/Auth/zlist";
                    });
