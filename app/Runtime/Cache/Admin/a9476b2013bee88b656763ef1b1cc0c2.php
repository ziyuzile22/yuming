                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <xblock>
                            ...
                            <button class="layui-btn" onclick="window.open('/admin.php/Fwq/zadd', 'right')"><i class="layui-icon"></i>添加</button>
                        ...
                        <table class="layui-table">
                            ...
                            <tbody id="tbody">
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                        <td>
                                            <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo ($data["fwq_id"]); ?>'><i class="layui-icon">&#xe605;</i></div>
                                        </td>
                                        <td><?php echo ($data["fwq_id"]); ?></td>
                                        <td><?php echo ($data["fwq_name"]); ?></td>
                                        <td><?php echo ($data["fwq_site"]); ?></td>
                                        <td><?php echo ($data["fwq_admin"]); ?></td>
                                        <td><?php echo ($data["fwq_pwd"]); ?></td>
                                        <td><a href="<?php echo ($data["fwq_mb"]); ?>" target="_blank" style="color: blue;"><?php echo ($data["fwq_mb"]); ?></a></td>
                                        <td><?php echo ($data["fwq_mbadmin"]); ?></td>
                                        <td><?php echo ($data["fwq_mbpwd"]); ?></td>
                                        <td><?php echo (date("Y-m-d", $data["fwq_dq"])); ?></td>
                                        <td>
                                            <a class="layui-btn layui-btn-xs" href="/admin.php/Fwq/zedit/fwq_id/<?php echo ($data["fwq_id"]); ?>">编辑</a>
                                            <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="member_del(this,'<?php echo ($data["fwq_id"]); ?>')" href="javascript:;">删除</a>
                                        </td>
