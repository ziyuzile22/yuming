...
<body>
                        ...
                        <form class="layui-form layui-form-pane" action="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="mg_role_id" lay-verify="required">
                                        <option value=""></option>
                                        <?php if(is_array($roleinfo)): $i = 0; $__LIST__ = $roleinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["role_id"]); ?>"><?php echo ($vo["role_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <?php if(is_array($xminfo)): $i = 0; $__LIST__ = $xminfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xm): $mod = ($i % 2 );++$i;?><input type="checkbox" name="mg_xm[]" value="<?php echo ($xm["xm_id"]); ?>" title="<?php echo ($xm["xm_name"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
    ...
    layui.use('form', function() {
        ...
        form.on('submit(zadd)', function(data){
            var data = data.field;
            var url = "/admin.php/Manager/zadd.html";
