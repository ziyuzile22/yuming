...
function reload(){
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md8">
                    <div class="layui-card">
                        <div class="layui-card-header">修改域名注册账户</div>
                        <div class="layui-card-body">
                            <form class="layui-form" action="">
                                <input type="hidden" name="zc_id" value="<?php echo ($info["zc_id"]); ?>">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">注册地址昵称</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_name" value="<?php echo ($info["zc_name"]); ?>" required lay-verify="required" placeholder="注册地址昵称" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">域名注册地址</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_site" value="<?php echo ($info["zc_site"]); ?>" required lay-verify="required" placeholder="请输入域名注册地址" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_admin" value="<?php echo ($info["zc_admin"]); ?>" placeholder="用户名" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">密码</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_pwd" value="<?php echo ($info["zc_pwd"]); ?>" placeholder="密码" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">绑定手机号码</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_tell" value="<?php echo ($info["zc_tell"]); ?>" placeholder="绑定手机号码" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">号码联系人</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_tellname" value="<?php echo ($info["zc_tellname"]); ?>" placeholder="号码联系人" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
    ...
    layui.use('form', function() {
        ...
        form.on('submit(zedit)', function(data) {
            var data = data.field;
            var url = "/admin.php/Zc/zedit/zc_id/8";
            $.post(url, data, function(result) {
                ...
                if (result.status == 1) {
                    layer.msg(result.message, { icon: 1, time: 800 }, function() {
                        window.location.href = "/admin.php/Zc/zlist";
                    });
                }
            }, 'JSON');
            return false;
