...
function reload(){
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body">
                            <form class="layui-form" action="post">
                                ...
                                <input type="hidden" name="mg_name" value="<?php echo ($info["mg_name"]); ?>">
                                <input type="hidden" name="mg_role_id" value="<?php echo ($info["mg_role_id"]); ?>">
    ...
    layui.use('form', function() {
        ...
        form.on('submit(zedit)', function(data){
            var data = data.field;
            var url = "/admin.php/Manager/zself";
