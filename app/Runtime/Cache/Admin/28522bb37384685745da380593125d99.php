                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body">
                            <form class="layui-form layui-form-pane" action="">
                                <input type="hidden" name="zhu_id" value="<?php echo ($info["zhu_id"]); ?>">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">主域名</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zhu_site" value="<?php echo ($info["zhu_site"]); ?>" required lay-verify="required" placeholder="主域名地址" autocomplete="off"
                                            class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="zhu_zc" required lay-verify="required">
                                            ...
                                            <?php if(is_array($zcinfo)): $i = 0; $__LIST__ = $zcinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zc): $mod = ($i % 2 );++$i;?><option <?php if(($zc["zc_id"]) == $info["zhu_zc"]): ?>selected<?php endif; ?>
                                                    value="<?php echo ($zc["zc_id"]); ?>"><?php echo ($zc["zc_name"]); ?>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="zhu_xm" required lay-verify="required">
                                            <option value="">----请选择----</option>
                                            <?php if(is_array($xminfo)): $i = 0; $__LIST__ = $xminfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xm): $mod = ($i % 2 );++$i;?><option <?php if(($xm["xm_id"]) == $info["zhu_xm"]): ?>selected<?php endif; ?>
                                ...
                                <div class="layui-form-item" pane>
                                    ...
                                    <div class="layui-input-block">
                                        <input type="radio" name="zhu_beian" value="2" <?php if(($info["zhu_beian"]) == "2"): ?>checked<?php endif; ?> title="有">
                                        <input type="radio" name="zhu_beian" value="1" <?php if(($info["zhu_beian"]) == "1"): ?>checked<?php endif; ?> title="无">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="zhu_dq" value="<?php echo (date('Y-m-d H:i:s', $info["zhu_dq"])); ?>" placeholder="服务器到期时间" autocomplete="off" id="zhu_dq"
                                            class="layui-input">
                                    </div>
                                </div>
    ...
    <script>
        ...
        layui.use('form', function () {
            ...
            form.on('submit(zedit)', function (data) {
                var data = data.field;
                var url = "/admin.php/Zhu/zedit/zhu_id/80";
