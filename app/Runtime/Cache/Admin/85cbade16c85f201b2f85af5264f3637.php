            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md8">
                    <div class="layui-card">
                        <div class="layui-card-header">添加域名注册账户</div>
                        <div class="layui-card-body">
                            <form class="layui-form" action="">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">域名注册地址</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_site" required lay-verify="required" placeholder="请输入域名注册地址" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">注册地址昵称</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_name" required lay-verify="required" placeholder="注册地址昵称" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">用户名</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_admin" placeholder="用户名" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">密码</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_pwd" placeholder="密码" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">绑定手机号码</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_tell" placeholder="绑定手机号码" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">号码联系人</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="zc_tellname" placeholder="号码联系人" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
