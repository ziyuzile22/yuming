                        ...
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="art_title" required lay-verify="required" placeholder="请输入文章标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">文章内容</label>
                                <div class="layui-input-block">
                                    <textarea name="art_content" id="textarea_id" style="padding:10px;"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="art_weight" placeholder="权重" autocomplete="off" class="layui-input">
                                </div>
    ...
    <script>
        ...
        layui.use('form', function () {
            ...
            form.on('submit(zadd)', function (data) {
                var data = data.field;
                var url = "/admin.php/Article/zadd/ym_xm/4";
